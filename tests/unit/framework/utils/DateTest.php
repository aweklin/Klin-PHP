...
class DateTest extends TestCase {
    ...
    public function testToday() {
        Date::setTimeZone('GMT'); // this may fail, based on the TimeZone of the user, you may want to change the TimeZone to pass all test in this method
    ...
    public function testDateDifference() {
        ...
        // month
        self::assertSame(0, Date::getMonthDifference('2020-07-01', '2020-07-31'));
        self::assertSame(1, Date::getMonthDifference('2020-07-01', '2020-08-31'));
    ...
    #[TestWith(['2024-09-30', '2024-09-01'])]
    #[TestWith(['2024-01-20', '2024-01-01'])]
    public function testFirstDate(string $input, string $expectedOutput) {
        // when
        $actualOutput = Date::getFirstDayOf($input);

        // then
        $this->assertSame($actualOutput, $expectedOutput);
    }

    #[TestWith(['2024-09-30', '2024-09-30'])]
    #[TestWith(['2024-01-20', '2024-01-31'])]
    #[TestWith(['2024-02-05', '2024-02-29'])]
    public function testLastDate(string $input, string $expectedOutput) {
        // when
        $actualOutput = Date::getLastDayOf($input);
